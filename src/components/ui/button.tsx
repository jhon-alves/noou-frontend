...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-1 rounded-full font-semibold transition-all duration-200 cursor-pointer disabled:cursor-not-allowed whitespace-nowrap disabled:text-gray-400 disabled:dark:text-gray-800 disabled:bg-gray-200 disabled:dark:bg-gray-400/60 disabled:opacity-100",
  {
    variants: {
      variant: {
        filled: "bg-[#111827] dark:bg-white text-white dark:text-[#111827] hover:opacity-90",
